            ...
            if entity:
                ...
                if entity_team_id != pm.read_int(entity_i + m_iTeamNum):
                    ...
                    if pm.read_string(info + 0x10) != 'GOTV':
                        ...
                        try :
                            listbox.insert(END, pm.read_string(info + 0x10) + "   -->   " + ranks[rank] + " " + str(rank))
                        except :
                            try :
                                listbox.insert(END, pm.read_string(info + 0x10).encode('iso-8859-1').decode() + "   -->   " + ranks[rank] + " " + str(rank))
                            except :
                                listbox.insert(END, "? -->   " + ranks[rank] + " " + str(rank))
